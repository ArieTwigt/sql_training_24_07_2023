...
SELECT 
       ...
       CASE WHEN brands_motor_power.pct_power_electric >= 20 THEN 'large' ELSE 
            CASE WHEN brands_motor_power.pct_power_electric BETWEEN 10 AND 20 THEN 'medium' ELSE 
                CASE WHEN brands_motor_power.pct_power_electric < 10 THEN 'small'
                END
            END
        END
        AS pct_electric_cat
